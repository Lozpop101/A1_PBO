...
public class Main {
    ...
    public static void main(String[] args){
        ...
        ikanda = new AirTawar(1, "demo", "warna", 3, 4, "tawar");
        listData.add(ikanda);
        ...
        do {
            ...
            System.out.println("4. Ikan Platy.  Warna : Kuning, Jingga.  Rp30000/ekor");
            System.out.println("===================================");
            System.out.println("===================================");
            ...
            System.out.println("9> Total ikan yang tersedia berdasarkan tempat hidupnya");
    ...
    public static void airtawar(){
        ...
        int menu2;
        System.out.println(" ~~ Kios Ikan Hias Minaria ~~ ");
        System.out.println(">> Daftar Ikan hias Air Tawar yang tersedia :");
        ...
        System.out.println("5. Ikan Zebra.  Warna : Putih, Hitam, Silver.  Rp60000/ekor");
        System.out.println("6. Ikan Oscar.  Warna : Hitam, Putih, Jingga.  Rp45000/ekor");
        System.out.println("===================================");
        System.out.println("===================================");
        System.out.println("=============  Menu  ==============");
        System.out.println("1> Tambah data pesanan");
    ...
    public static void airlaut(){
        ...
        int menu3;
        System.out.println(" ~~ Kios Ikan Hias Minaria ~~ ");
        System.out.println(">> Daftar Ikan hias Air Laut yang tersedia :");
    ...
    public static void tambah_data(int data){
        ...
        if(data == 2) {
            ikanda = new AirTawar(id, jenisikan, warnaikan, jumlah, harga, "tawar");
            listData.add(ikanda);
        } else if(data == 3){
            ikanda = new AirLaut(id, jenisikan, warnaikan, jumlah, harga, "laut");
            listData.add(ikanda);
        } else if(data == 1){
            ikanda = new AirLaut(id, jenisikan, warnaikan, jumlah, harga, "tawar/laut");
            listData.add(ikanda);
        }
    ...
    public static void totaljenis_dapatdibeli(){
        Ikan.totaljenis1();
        AirTawar.totaljenis2();
        AirLaut.totaljenis3();
        System.out.println();
        input_lagi();
    }
